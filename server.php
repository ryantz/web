...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($customer_name)) { array_push($errors, "Your name is required"); }
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO customer (username, email, password, customer_name, address, phone) 
  			  VALUES('$username', '$email', '$password', '$customer_name', '$address', '$phone')";
